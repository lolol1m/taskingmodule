...
class ConfigClass(SingletonEnv):
    ...
    def __init__(self):
        ...
        self.allowed_client_ids = os.getenv("ALLOWED_CLIENT_IDS", "xbi-tasking-frontend, xbi-tasking-backend, xbi-tasking-admin").split(',')
        self.roles_client_id = os.getenv("ROLES_CLIENT_ID", "xbi-tasking-frontend")
        self.required_group = os.getenv("REQUIRED_GROUP", "xbi-tasking-users")
    ...
    def getKeycloakAllowedClientIDs(self):
        return self.allowed_client_ids

    def getKeycloakRolesClientID(self):
        return self.roles_client_id
