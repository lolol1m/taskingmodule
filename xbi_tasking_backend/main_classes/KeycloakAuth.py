...
class KeycloakAuth:
    ...
    def __init__(self, config=None, eager=True):
        ...
        self.well_known_url = f"{self.keycloak_internal_url}/realms/{self.realm}/.well-known/openid-configuration"
        self.jwks_url = None
    ...
    def _validate_issuer_audience(self, claims: dict) -> bool:
        expected_issuer = f"{self.keycloak_public_url}/realms/{self.realm}"
